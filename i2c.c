...
struct I2C { // I2C registers
    ...
    int clock_divider;
    int data_delay;
    int clock_stretch_timeout; //writing to this field will set the CDIV
};
...
{
    //from danny on ed
    i2c->clock_stretch_timeout = 0x80; // double the default timeout from clk stretch
